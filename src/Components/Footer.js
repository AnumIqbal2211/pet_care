          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="footer-top-info">
                ...
                <p>Give us a free call (224) 228-8475</p>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-4 col-md-12">
              <div class="footer-wid">
                ...
                <a href="#" class="link-color">
                  Read More About Us <i class="fa  fa-long-arrow-right"></i>
                </a>
              </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4 col-lg-4">
                  <div class="footer-wid footer-menu">
                    ...
                    <ul>
                      <li>
                        <i class="fa  fa-angle-right"></i> Monday:7:30am -
                        5:30pm
                      </li>
                      <li>
                        <i class="fa  fa-angle-right"></i> Tuesday:7:30am -
                        5:30pm
                      </li>
                      <li>
                        <i class="fa  fa-angle-right"></i> Wednesday:7:30am -
                        5:30pm
                      </li>
                      <li>
                        <i class="fa  fa-angle-right"></i> Thursday:7:30am -
                        5:30pm
                      </li>
                      <li>
                        <i class="fa  fa-angle-right"></i> Friday:7:30am -
                        5:30pm
                      </li>
                      <li>
                        <i class="fa  fa-angle-right"></i> Saturday:7:30am -
                        3:00pm
                      </li>
                      <li>
                        <i class="fa  fa-angle-right"></i> Sunday: Closed
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="col-md-4 col-lg-4">
                  <div class="footer-wid map-preview">
                    ...
                    <div class="address-info">
                      <span>
                        <i class="fa  fa-phone"></i> (224) 228-8475
                      </span>
                      <br></br>
                      <span>
                        ...
                        <a
                          ...
                          class="__cf_email__"
                          data-cfemail="0a797f7a7a65787e4a7a6f7e69666364636924696567"
                        >
                          [email&#160;protected]
                        </a>{" "}
                      </span>
